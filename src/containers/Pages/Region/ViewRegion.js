...
import { fetchRegion } from '../../../store/actions/Region/region';
        ...
        <div className="card">
          <div class="card-body">
            ...
            <div className="row">
              ...
              <hr />
                <Link to ="/Region"><button className="btn btn-primary" style={{float : 'right'}}>Add Region</button></Link>
              </div>
            </div>
                ...
                <tbody>
                  {region ? (
                    region.map(function(item, id) {
                      return (
                        <tr key={id}>
                          <th scope="row">{item.region_name || "NO DATA"}</th>
                        </tr>
                      );
                    }, this)
                  ) : (
...
export default connect(mapStateToProps, { fetchRegion })(ViewRegion);
