...
import "./FlakinessIndex.css";
import { connect } from "react-redux";
import { Link, NavLink } from "react-router-dom";
// import {postNewArea} from '../../../store/actions/Area/area';
export class FlakinessIndex extends Component {
  constructor(props) {
    super(props);
    // React state
    this.state = {
        ...
        <div class="breadcrumb-holder">
          <div class="container-fluid">
            <ul class="breadcrumb">
              ...
              <li class="breadcrumb-item active">Flakiness Index</li>
            </ul>
          </div>
        </div>
        <br />
              ...
              <div class="col-lg-12">
                <div class="card">
                  <div class="card-header d-flex align-items-center">
                    <h4>Flakiness Index</h4>
                  </div>
                  <div class="card-body">
                    <p>
                      {" "}
                      Test Format - RF:09
                      <br /> (Determination of Aggregate Flakiness Index IS :
                      2386 (Part 1) - 1963)
                    </p>
