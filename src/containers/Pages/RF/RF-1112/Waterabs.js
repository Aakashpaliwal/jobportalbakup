...
export class Waterabs extends Component {
    constructor(props) {
        super(props);
        // React state
        this.state = {
  ...
  render() {
    ...
    let buttontitle = "click to see RF 12";
    let formtext;
    let testformtext;
    let formheadertext;
    if (this.state.formstatus) {
      buttontitle = "click to see RF 11";
      testformtext = (
        <div>
                ...
                <div class="form-group col-md-12">
                  <table class="table table-bordered">
                    ...
                    <tbody>
                      <tr>
                        <th scope="row">
                          Weight of pycnometer with aggregate and water
                        </th>
                        <td>A</td>
                        <td>
                          <input
                      ...
                      <tr>
                        <th scope="row">Weight of pycnometer with water</th>
                        <td>B</td>
                        <td>
                          <input
                            type="text"
                      ...
                      <tr>
                        <th scope="row">
                          Weight of surface dried aggregates removed from
                          pycnometer
                        </th>
                        <td>C</td>
                        <td>
        ...
        <div>
          <div className="col-lg-12 col-md-12 col-sm-12 col-xs-12 text-center center-block">
            <p style={{ textAlign: "center" }}>
              Test Format - RF:12 (Determination of Specific gravity and water
      ...
      formheadertext = (
        <div>
          <div className="col-lg-12 col-md-12 col-sm-12 col-xs-12 text-center center-block">
            <p style={{ textAlign: "center" }}>
              Test Format - RF:11 (Determination of Specific gravity and water
              absorption of Coarse aggregate metthod 2)
            </p>
            <hr />
          </div>
        </div>
        ...
        <div class="breadcrumb-holder">
          <div class="container-fluid">
            <ul class="breadcrumb">
              ...
              <li class="breadcrumb-item active">Gravity &amp; Water Abs</li>
            </ul>
          </div>
        </div>
        <br />
