...
export class SurfaceMoisture extends Component {
    constructor(props) {
        super(props);
        // React state
        this.state = {
  ...
  render() {
    ...
    let buttontitle = "click to see RF 16";
    let formtext;
    let testformtext;
    let formheadertext;
    if (this.state.formstatus) {
      buttontitle = "click to see RF 15";
      testformtext = (
        <div>
                ...
                <div class="form-group col-md-12">
                  <table class="table table-bordered">
                    ...
                    <tbody>
                      <tr>
                        <th scope="row">
                          Standard water absorption of aggregates
                        </th>
                        <td>
                          W<sub>a</sub>
                        </td>
                      ...
                      <tr>
                        <th scope="row">Wet weight of aggregates</th>
                        <td>A</td>
                        <td>
                          <input
                            type="text"
                      ...
                      <tr>
                        ...
                        <td>
                          <em>Calculation here [A - B / B * 100] %</em>
                        </td>
                      </tr>
                      <tr>
                        ...
                        <td>
                          <em>
                            Calculation here [C - W<sub>a</sub>] %
                          </em>
                        </td>
                      </tr>
                    </tbody>
        ...
        <div>
          <div className="col-lg-12 col-md-12 col-sm-12 col-xs-12 text-center center-block">
            <p style={{ textAlign: "center" }}>
              Test Format : RF-16
              <br />
              Determination of surface moisture content of Aggregates (Oven
              Drying Method) IS : 2386 (Part 3) – 1963{" "}
            </p>
            <hr />
          </div>
        </div>
        ...
        <div>
          <div className="col-lg-12 col-md-12 col-sm-12 col-xs-12 text-center center-block">
            <p style={{ textAlign: "center" }}>
              Test Format : RF-15
              <br />
              Determination of surface moisture content of Aggregates (Field
        ...
        <div class="breadcrumb-holder">
          <div class="container-fluid">
            <ul class="breadcrumb">
              ...
              <li class="breadcrumb-item active">Surface Moisture</li>
            </ul>
          </div>
        </div>
        <br />
